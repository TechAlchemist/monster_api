Monster.create([
    ...
    {name: 'Godzilla', height: 500, weight: 6000, description: 'Prehistoric sea monster, scaly, seen mostly in japan, and like to destroy things.'},
    ...
    {name: 'Pyramid Head', height: 7, weight: 220, description: 'Has a  triangular face, gruesomely stacked arms, giant sword, and ability to rip the skin clean off somebody’s body.'},
    ...
    {name: 'Nosferatu', height: 6, weight: 150, description: 'The original vampire, long pointy front teeth, bald and long ears.'},
    ...
    {name: 'Puffskein', height: 0.5, weight: 0.5, description: 'Round, furry creatures adored by wizard children.'},
